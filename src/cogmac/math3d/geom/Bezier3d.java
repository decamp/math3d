...
public class Bezier3d {
    ...
    public Bezier3d subdivide( double t0, double t1 ) {
        ...
        if( Math.abs(t1 - 1.0) < ABS_ERR ) {
            if( Math.abs(t0) < ABS_ERR ) {
                ret = new Bezier3d(mC.clone(), mCount);
            }else{
                ret = subdivideGreater(t0);
            }
        
        }else if( Math.abs(t1) < ABS_ERR ) {
            if( Math.abs(t0) < ABS_ERR ) {
     ...
     * Equivalent to calling solveTFromX(x, 0.5);
     * 
     * @param x Desired <tt>x</tt> coordinate.
     * @return <tt>t</tt> value where the x-coordinate of this Bezier reaches <tt>x</tt>.  Possibly NaN.
     * @throws UnsupportedOperationException if <code>isSolvable() == false</code>.
     */
     ...
     * 
     * @param x          Desired <tt>x</tt> coordinate.
     * @param nearestT   In case there are multiple valid values of T, the one closest to <tt>nearestT</tt> will be returned. 
     * @return <tt>t</tt> value where the x-coordinate of this Bezier reaches <tt>x</tt>.
     * @throws UnsupportedOperationException if <code>isSolvable() == false</code>.
     */
     ...
     * Equivalent to calling solveTFromY(y, 0.5);
     * 
     * @param y Desired <tt>y</tt> coordinate.
     * @return <tt>t</tt> value where the y-coordinate of this Bezier reaches <tt>y</tt>.  Possibly NaN.
     * @throws UnsupportedOperationException if <code>isSolvable() == false</code>.
     */
     ...
     * @param y          Desired <tt>y</tt> coordinate.
     * @param nearestT   In case there are multiple valid values of T, the one closest to <tt>nearestT</tt> will be returned. 
     * @return <tt>t</tt> value where the x-coordinate of this Bezier reaches <tt>y</tt>.
     * @throws UnsupportedOperationException if <code>isSolvable() == false</code>.
     */
     ...
     * Equivalent to calling solveTFromZ(z, 0.5);
     * 
     * @param z Desired <tt>z</tt> coordinate.
     * @return <tt>t</tt> value where the z-coordinate of this Bezier reaches <tt>z</tt>.  Possibly NaN.
     * @throws UnsupportedOperationException if <code>isSolvable() == false</code>.
     */
     ...
     * @param z          Desired <tt>z</tt> coordinate.
     * @param nearestT   In case there are multiple valid values of T, the one closest to <tt>nearestT</tt> will be returned. 
     * @return <tt>t</tt> value where the x-coordinate of this Bezier reaches <tt>z</tt>.
     * @throws UnsupportedOperationException if <code>isSolvable() == false</code>.
     */
