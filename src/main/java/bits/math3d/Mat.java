...
public final class Mat {
    ...
    public static void mult( Mat3 a, Vec3 b, Vec3 out ) {
    ...
    public static void transpose( Mat3 a, Mat3 out ) {
        float a0 = a.m00;
        float a1 = a.m10;
        float a2 = a.m20;
        float a3 = a.m01;
    ...
    public static float det( Mat3 mat ) {
    ...
    public static void identity( Mat3 out ) {
        out.m00 = 1f;
        out.m10 = 0f;
        out.m20 = 0f;
        out.m01 = 0f;
    ...
    public static void mult( Mat4 a, Vec3 b, Vec3 out ) {
        float b0 = b.x;
        float b1 = b.y;
        float b2 = b.z;
    ...
    public static void mult( Mat4 a, Vec4 b, Vec4 out ) {
    ...
    public static void transpose( Mat4 mat, Mat4 out ) {
    ...
    public static void translate( Mat4 mat, float tx, float ty, float tz, Mat4 out ) {
        float b0 = mat.m00;
        float b1 = mat.m01;
        float b2 = mat.m02;
        float b3 = mat.m03;
    ...
    public static void preTranslate( float tx, float ty, float tz, Mat4 mat, Mat4 out ) {
        float b0 = mat.m00;
        float b1 = mat.m10;
        float b2 = mat.m20;
        float b3 = mat.m30;
    ...
    public static void lookAt( Mat4 eyeVec, Mat4 centerVec, Mat4 upVec, Mat4 outMat ) {
    ...
    public static void viewport( float x, float y, float w, float h, Mat4 out ) {
        out.m00 = w * 0.5f;
        out.m10 = 0;
        out.m20 = 0;
        out.m30 = 0;
    ...
    public static void axesToTransform( Vec3 x, Vec3 y, Mat4 out ) {
        Vec3 z = new Vec3();
        Vec.cross( x, y, z );
    ...
    public static void axesToTransform( Vec3 x, Vec3 y, Vec3 z, Mat4 out ) {
        out.m00 = x.x;
        out.m10 = x.y;
        out.m20 = x.z;
        out.m30 = 0;
    ...
    public static void alignBasisVectorToAxis( Mat4 mat, int basis, Mat4 out ) {
        ...
        case 0:
        {
            ...
            y = new Vec3( mat.m01, mat.m11, mat.m21 );
            z = new Vec3( mat.m02, mat.m12, mat.m23 );
        ...
        case 1:
        {
            ...
            z = new Vec3( mat.m02, mat.m12, mat.m22 );
            x = new Vec3( mat.m00, mat.m10, mat.m20 );
    ...
    public static boolean clampToCone( Vec3 vec, Vec3 coneAxis, float coneRads, Vec3 outVec, Mat4 outMat ) {
        float cosAng = Vec.cosAng( vec, coneAxis );
    ...
    public static boolean isNaN( Mat4 mat ) {
        return Float.isNaN( mat.m00 ) ||
               Float.isNaN( mat.m10 ) ||
               Float.isNaN( mat.m20 ) ||
               Float.isNaN( mat.m30 ) ||
    ...
    public static void alignBasisVectorToAxis4( double[] mat, int basis, double[] out ) {
        ...
        // Clamp specified vector to nearest axis.
        Vec.nearestAxis3( mat[basis * 4], mat[basis * 4 + 1], mat[basis * 4 + 2], out );
        ...
        Vec.cross3( out, basis * 4, mat, basis1 * 4, out, basis2 * 4 );
        Arr.normalize( out, basis2 * 4, 3, 1.0 );
        Vec.cross3( out, basis2 * 4, out, basis * 4, out, basis1 * 4 );
    ...
    public static boolean clampToCone4( double[] vec,
                                        ...
                                        double[] outVec,
                                        double[] outMat ) {
        double cosAng = Vec.cosAng3( vec, coneAxis );
