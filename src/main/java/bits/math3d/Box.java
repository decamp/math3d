...
public final class Box {
     ...
     * <code>intersect( { 0, 0, 1, 1 }, { 2, 0, 3, 0.5f }, out )</code>
     * will result in
     * {@code out = { 1, 0, 1, 0.5f }}.
     *
     * @param a   First box
     ...
     */
    public static void pointUnion( Vec2[] points, int off, int len, Box2 out ) {
        if( len == 0 ) {
    ...
    public static String format( Box2 b ) {
        return Box3.class.getSimpleName() +
               String.format( Vec.FORMAT2, b.x0, b.y0 ) +
               String.format( Vec.FORMAT2, b.x1, b.y1 );
    }
     ...
     * {@code srcDomain} into the coordinate space defined by {@code dstDomain}.
     */
    public static void mapPoint( float x, float y, float z, Box3 srcDomain, Box3 dstDomain, Vec3 out ) {
        out.x = ( x - srcDomain.x0 ) / ( srcDomain.x1 - srcDomain.x0 ) * ( dstDomain.x1 - dstDomain.x0 ) + dstDomain.x0;
        out.y = ( y - srcDomain.y0 ) / ( srcDomain.y1 - srcDomain.y0 ) * ( dstDomain.y1 - dstDomain.y0 ) + dstDomain.y0;
     ...
     * @param out     length-6 array that to hold the pointUnion of the points on return.
     */
    public static void pointUnion( Vec3[] points, int off, int len, Box3 out ) {
        if( len == 0 ) {
    ...
    public static String format( Box3 b ) {
        return Box3.class.getSimpleName() +
               String.format( Vec.FORMAT3, b.x0, b.y0, b.z0 ) +
               String.format( Vec.FORMAT3, b.x1, b.y1, b.z1 );
    }
    ...
    public static String format2( double[] v ) {
        return "Box2" +
               String.format( Vec.FORMAT2, v[0], v[1] ) +
               String.format( Vec.FORMAT2, v[2], v[3] );
    }
