...
public class Convolutions {
     ...
     */
    public static void convolve1( float[] src,
                                  int srcOff,
                                  int w,
                                  int h,
                                  int xStride,
    ...
    public static void convolveFillZero1( float[] src,
                                          int srcOff,
                                          int w,
                                          int h,
                                          int xStride,
    ...
    public static void convolveFillConstant1( float[] src,
                                              int srcOff,
                                              int w,
                                              int h,
                                              int xStride,
    ...
    public static void convolveRepeat1( float[] src,
                                        int srcOff,
                                        int w,
                                        int h,
                                        int xStride,
    ...
    public static void convolveReflectInner1( float[] src,
                                              int srcOff,
                                              int w,
                                              int h,
                                              int xStride,
    ...
    public static void convolveReflectOuter1( float[] src,
                                              int srcOff,
                                              int w,
                                              int h,
                                              int xStride,
    ...
    public static void convolveWrap1( float[] src,
                                      int srcOff,
                                      int w,
                                      int h,
                                      int xStride,
