...
public final class Aabb implements Cloneable, Serializable, Volume {
     ...
     * @param spanY  
     * @param spanZ
     * @returns new Aabb object with the specified min positions and size.
     */
     ...
     * @param y1  
     * @param z1  
     * @returns an Aabb object with specified face positions.
     */
     ...
     * @returns a new Aabb
     */
    public static Aabb fromCenter( double centerX,
                                   double centerY,
                                   double centerZ,
                                   double spanX,
                                   double spanY,
    ...
    /**
     * @returns the doubleersection between <code>this</code> Aabb and the
    ...
    /**
     * @returns the union between <code>this</code> Aabb and the parameter Aabb.
     *          The union may contain area not covered by either input Aabb.
     */
     ...
     * 
     * @param multX
     *            - Amount to multiply the width and left face.
     * @param multY
     *            - Amount to multiply the height and top face.
     * @param multZ
     *            = Amount to multiply the depth and front face.
     ...
     * 
     * @param dx
     *            - Amount to move the Aabb horizantally.
     * @param dy
     *            - Amount to move the Aabb vertically.
     * @param dz
     *            - Amount to move the Aabb depthally.
     * @returns a new Aabb.
     */
    ...
    /**
     * @param out6 On return, holds [minX, minY, minZ, maxX, maxY, maxZ]
     */
    public void toArray( double[] out6 ) {
        out6[0] = mX0;
        out6[1] = mY0;
        out6[2] = mZ0;
        out6[3] = mX1;
