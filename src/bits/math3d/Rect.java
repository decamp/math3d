...
public class Rect implements Serializable {
     ...
     * 
     * @param minX  The minX edge of the rectangle.
     * @param minY  The minY edge of the rectangle.
     * @param maxX  The maxX edge of the rectangle.
     * @param maxY  The maxY edge of the rectangle.
    ...
    /**
     * @returns the union between <code>this</code> Rect and the parameter Rect.  The
     * union may contain area not covered by either input Rect.
     */
