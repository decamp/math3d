...
public class Gaussian2 implements Function21 {
    ...
    public static Gaussian2 fromCovariance( double meanX,
                                            double meanY,
                                            double exx,
                                            double eyy,
                                            double exy,
    ...
    public static Gaussian2 fromSigma( double meanX,
                                       double meanY,
                                       double sigX,
                                       double sigY,
                                       double corr,
    ...
    private Gaussian2( double meanX, double meanY, double sigmaX, double sigmaY, double corr, double integral ) {
        ...
        mCoefXX = -1.0 / (2.0 * sigmaX * sigmaX * ompp);
        mCoefYY = -1.0 / (2.0 * sigmaY * sigmaY * ompp);
