...
//            Vec3[] vv = v;
            ...
            for( int i = 0; i < 3; i++ ) {
                Assert.assertTrue( Clip.clipPlanarWithBox( vv, 0, 3, clip, workLoop, loop ) );
    ...
    @Test public void testAllOut() {
        ...
        for( int m = 0; m < 8; m++ ) {
            ...
            for( int i = 0; i < 3; i++ ) {
                Assert.assertFalse( Clip.clipPlanarWithBox( vv, 0, 3, clip, workLoop, loop ) );
    ...
    @Test public void testClipCenterOfTriangle3() throws Exception {
        ...
        for( int m = 0; m < 8; m++ ) {
            ...
            for( int i = 0; i < 3; i++ ) {
                Assert.assertTrue( Clip.clipPlanar3( vv, 0, 3, clip, loop ) );
    ...
    @Test public void testAllOut3() {
        ...
        for( int m = 0; m < 8; m++ ) {
            ...
            for( int i = 0; i < 3; i++ ) {
                Assert.assertFalse( Clip.clipPlanar3( vv, 0, 3, clip, loop ) );
